...
func (b Bindings) AllPhysicalKeys() []string {
        ...
        add(b.Up); add(b.Down); add(b.Left); add(b.Right)
        add(b.GotoTop); add(b.GotoBottom)
        add(b.PrimaryAction); add(b.Cancel)
        add(b.ZenMode); add(b.CloseFile)
        add(b.PageUp); add(b.PageDown)
        add(b.HalfPageUp); add(b.HalfPageDown)
        add(b.TabSwitch)
        add(b.ConfirmExitC); add(b.ConfirmExitD)
        add(b.PinTab)
        add(b.FocusExplorer); add(b.FocusEditor)
        add(b.HelpExpand)
        add(b.Backspace)
        add(b.Indent)
        add(b.Outdent)
