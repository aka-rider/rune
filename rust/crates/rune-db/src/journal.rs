//! The durable undo/redo journal — port of `pkg/docstate/journal.go:39-205`
//! (`AppendEdit`), `journal.go:207-330` (`UndoPeek`/`RedoPeek`/
//! `MoveUndoPos`), `dirty.go:46` (`CurrentSeq`), and `snapshot.go:211-238`
//! (`EditsInRange`). CONSTITUTION §12: `doc_id` alone is always both the
