...
//! origin. Port of `pkg/docstate/observation.go`. See that file's package
//! doc comment (`observation.go:1-67`) for the "Three facts, three
//! derivations" model this crate's `sync`/`probe`/`materialize`/`adopt`
