//! Property tests mirroring the Go fuzz corpus in
//! `pkg/editor/buffer/buffer_test.go` (`FuzzBufferSnapshotImmutability`,
//! `FuzzBufferBatchEquivalence`, `FuzzBufferPointRoundtrip`), plus the
