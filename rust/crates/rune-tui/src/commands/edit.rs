...
//! (WP7). Port of `pkg/ui/components/textedit/commands_edit.go`'s
//! per-cursor commands, `commands_edit_lines.go`'s
//! `perCursorSelectionEdits` driver, and the peek-then-commit undo/redo
//! discipline of `pkg/ui/pages/workspace/workspace_undo.go:31-142`. The
