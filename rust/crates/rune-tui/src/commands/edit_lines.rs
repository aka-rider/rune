...
//! `edit.rs`, which was 802 lines before WP9 added anything). Port of
//! `pkg/ui/components/textedit/commands_edit_lines_indent.go` (indent/
//! outdent) and `commands_edit_lines_multi.go` (delete-line, clone-line-
//! up/down, move-line-up/down — plan WP9.S2).
//!
